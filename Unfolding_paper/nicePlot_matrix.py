...
matrix_norm.GetXaxis().SetTitleSize(0.04)
matrix_norm.GetXaxis().SetLabelSize(0.04)
matrix_norm.GetYaxis().SetTitle("p_{T,gen}^{H} [GeV]")
matrix_norm.GetYaxis().SetLabelFont(42)
matrix_norm.GetYaxis().SetTitleOffset(1.5)
matrix_norm.GetYaxis().SetTitleFont(42)
matrix_norm.GetYaxis().SetTitleSize(0.04)
matrix_norm.GetYaxis().SetLabelSize(0.04)
matrix_norm.GetZaxis().SetRangeUser(0,1)
matrix_norm.GetZaxis().SetLabelFont(42)
matrix_norm.GetZaxis().SetTitleOffset(1.1)
matrix_norm.GetZaxis().SetTitleFont(42)
matrix_norm.GetZaxis().SetTitleSize(0.04)
matrix_norm.GetZaxis().SetLabelSize(0.04)
#matrix_norm.SetMinimum(-0.01)
#matrix_norm.GetZaxis().SetRangeUser(-0.0000001, 1)
matrix_norm.SetMarkerSize(1.2)
#matrix_norm.SetContour(255)
