...
for l in list :
  ...
  else: matrix_file = TFile("responseMatricesPreApp/responseMatrix_"+str(l)+"_NEW.root")
...
ccov.Print("covariance_"+str(kreg)+"_bugfix.eps")
ccov.Print("covariance_"+str(kreg)+"_bugfix.C")
