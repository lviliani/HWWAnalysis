...
#     cut('projMet',    'projMet','( same() &&  min(projPfMet,projChargedMet) > 35 ) || ( different() && min(projPfMet,projChargedMet) > 20 ) '),
    cut('projMet',    'projMet','( same() && min(projPfMet,projChargedMetSmurf) > 35. ) || ( different() && min(projPfMet,projChargedMetSmurf) > 20. ) '),
