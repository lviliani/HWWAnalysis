...
for mass in masses:
    ...
    cmds.append(
        'makePlots.py --luminosity='+str(lumi)+' --path='+ntuplePath+' --optVars="higgsMass='+str(mass)+'" -p macros/plots/hww_extra.cfg  -s macros/samples/hww_data11_vars.cfg -o '+finalPath+'/h'+str(mass)+'_extra.root'
    )
