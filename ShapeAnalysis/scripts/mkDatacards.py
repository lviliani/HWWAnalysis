...
#
    ...
    def _addDataDrivenNuisances(self, nuisances, yields, mass, channel, jetcat, suffix, opts):
        ...
        mapping = {
            ...
            'Topge1jetCtrlBin0': ( jetcat+cb,  ['Topge1jetCtrlBin0']       ),
            'Topge1jetCtrlBin1': ( jetcat+cb,  ['Topge1jetCtrlBin1']       ),
            'Topge1jetCtrlBin2': ( jetcat+cb,  ['Topge1jetCtrlBin2']       ),
            'Topge1jetCtrlBin3': ( jetcat+cb,  ['Topge1jetCtrlBin3']       ),
            'Topge1jetCtrlBin4': ( jetcat+cb,  ['Topge1jetCtrlBin4']       ),
            'Topge1jetCtrlBin5': ( jetcat+cb,  ['Topge1jetCtrlBin5']       ),
            'DYLL'     : ( jetcat+cb,  ['DYLL']      ),
...
#     masses = hwwinfo.masses[:] if opt.mass == 0 else [opt.mass]
    ...
    #             for flavor in flavors:
                ...
                order = [ 'ggH', 'ggHBin0','ggHBin1','ggHBin2','ggHBin3','ggHBin4','ggHBin5', 'ggHFidBin0','ggHFidBin1','ggHFidBin2','ggHFidBin3','ggHFidBin4','ggHFidBin5', 'ggH_ALT','qqH', 'qqHBin0', 'qqHBin1', 'qqHBin2', 'qqHBin3', 'qqHBin4', 'qqHBin5', 'qqHFidBin0', 'qqHFidBin1', 'qqHFidBin2', 'qqHFidBin3', 'qqHFidBin4', 'qqHFidBin5', 'qqH_ALT', 'wzttH','wzttH_ALT', 'WH', 'WHBin0', 'WHBin1', 'WHBin2', 'WHBin3', 'WHBin4', 'WHBin5', 'WHFidBin0', 'WHFidBin1', 'WHFidBin2', 'WHFidBin3', 'WHFidBin4', 'WHFidBin5', 'ZH', 'ZHBin0', 'ZHBin1', 'ZHBin2', 'ZHBin3', 'ZHBin4', 'ZHBin5', 'ZHFidBin0', 'ZHFidBin1', 'ZHFidBin2', 'ZHFidBin3', 'ZHFidBin4', 'ZHFidBin5', "ggHNonFid", "qqHNonFid", "WHNonFid", "ZHNonFid", 'ttH', 'ggWW', 'VgS', 'Vg', 'WJet', 'Top', 'Top0jet', 'Topge1jet', 'Topge1jetBin0', 'Topge1jetBin1','Topge1jetBin2','Topge1jetBin3','Topge1jetBin4','Topge1jetBin5', 'Topge1jetCtrl','Topge1jetCtrl','Topge1jetCtrlBin0', 'Topge1jetCtrlBin1','Topge1jetCtrlBin2','Topge1jetCtrlBin3','Topge1jetCtrlBin4','Topge1jetCtrlBin5', 'Top0jet_nowe', 'Topge1jet_nowe', 'TopPt0', 'TopPt1', 'TopPt2', 'TopPt3', 'TopPt4', 'TopPt5', 'TopPt6', 'TopPt7', 'TopPt8', 'WW', 'WWewk', 'DYLL', 'VV', 'DYTT', 'DYee', 'DYmm', 'DYee05', 'DYmm05', 'Other', 'VVV', 'Data','ggH_SM', 'qqH_SM', 'WH_SM','ZH_SM' , 'wzttH_SM', 'ggH_sbi', 'ggH_s', 'ggH_b', 'qqH_sbi', 'qqH_s', 'qqH_b', 'WWBin0', 'WWBin1', 'WWBin2', 'WWBin3', 'WWBin4', 'WWBin5',]
