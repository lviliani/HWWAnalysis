...
# _____________________________________________________________________________
    ...
    def _getHwidthrange(self,mass,cat):
        ...
        if cat in ['1j'] :
          ...
          return ([12, 40, 70, 100,           300],[-1.00, -0.80, -0.70, -0.60, -0.50, -0.40, -0.30, -0.20, -0.10, 0.00, 0.25, 0.50, 1.00])
          ...
          return ([12,  40, 70,           150, 300],[0, 50,     100, 130, 170, 250, 450])
    ...
    def _getSimpleHwidthrange(self,mass,cat):
        ...
        if cat in ['0j','1j'] :
         # mth:mll                    mll in x                    mth in y
          return ([12, 40, 70, 100, 150, 200, 300],[0, 50, 70, 90, 110, 130, 170, 450])
          #return ([12, 40, 70, 100, 150, 200, 300],[0, 30, 80, 120, 150, 200, 400, 450])
